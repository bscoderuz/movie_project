    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Enter the dollar amount', verbose_name='US fees')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='Enter the dollar amount', verbose_name='World fees')),
                ('url', models.SlugField(max_length=150, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.reviews', verbose_name='Parent')),
            ],
            options={
                'verbose_name': 'Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=150, verbose_name='Title')),
                ('description', models.TextField(verbose_name='Description')),
                ('image', models.ImageField(upload_to='movie_shorts/', verbose_name='Image')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='Film')),
            ],
            options={
